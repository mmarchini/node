...
//     allocator.zero_fill_field());
  ...
  // auto env = new node::Environment(&isolate_data, context);
  // node::BaseObject obj(env, object);
  // EXPECT_EQ(value, 42);
}}
'''
  # // EXPECT_EQ(nodedbg_environment_context_idx_embedder_data, node::Environment::kContextEmbedderDataIndex);
  # // EXPECT_EQ(nodedbg_class__BaseObject__persistent_handle, node::Environment::kContextEmbedderDataIndex);
...
def create_test_file():
  ...
  out.write(test_template.format(
    symbols_file=render_symbols_file(),
    filename=sys.argv[0],
  ))
